	...
	[
		{
			...
			shadow: EnumShadowSubAgentsName.Nightmare,
		...
		},
		{
			...
			parentModel: "anthropic/claude-3",
			shadow: EnumShadowSubAgentsName.Nightmare,
			config: { agents: { nightmare: { model: "config/model" } } } as IAriseConfig,
		...
		},
		{
			...
			parentModel: "anthropic/claude-3",
			shadow: EnumShadowSubAgentsName.Nightmare,
			config: { agents: { nightmare: { model: AUTO_MODEL } } } as IAriseConfig,
		...
		},
		{
			...
			parentModel: undefined,
			shadow: EnumShadowSubAgentsName.Nightmare,
			config: { agents: { nightmare: { model: "azure/openai/gpt-4" } } } as IAriseConfig,
