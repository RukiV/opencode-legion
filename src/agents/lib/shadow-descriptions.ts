...
export const SHADOW_DESCRIPTIONS = {
  ...
  [EnumShadowSubAgentsName.Igris]: {
    ...
    roleKeywords: ["implement", "edit", "change", "fix", "code", "write", "run", "test", "build", "naming", "convention", "comment", "format"],
  ...
  [EnumShadowSubAgentsName.ShadowSovereign]: {
    ...
    roleKeywords: ["debug", "complex", "why", "reason", "analyze", "reasoning", "review", "verify", "check", "skeptical"],
    supportsBackground: false,
  },
