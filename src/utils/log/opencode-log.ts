 ...
 * @see App
 */
export async function log2OpenCode<ThrowOnError extends boolean = false>(ctx: IEventHandlerContext,
	fn: () => ITSResolvable<Options<AppLogData, ThrowOnError>>,
)
{
 ...
 */
export async function showToastOpenCode<ThrowOnError extends boolean = false>(ctx: IEventHandlerContext,
	fn: () => ITSResolvable<Options<TuiShowToastData, ThrowOnError>>,
)
{
